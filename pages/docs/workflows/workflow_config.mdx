...
The nodes represent the different components of the workflow, while the edges define the connections between these components.
To enter into the code view of the workflow, click on the `Code View` toggle on the top of the workflow editor. 
...
**Example Workflow**
![Example Workflow](/assets/workflow_config_example.png)
